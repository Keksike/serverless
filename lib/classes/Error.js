 ...
 * Also left-pads each line with spaces.
 *
...
module.exports.logError = (e) => {
  ...
  try {
    ...
    if (process.env.SLS_DEBUG) errorObject.stackTrace = e.stack;
    ...
    logErrMessage(errorObject.type, errorObject.message);

    if (e.name !== 'Serverless Error') {
      logDebugMessage();
    }
